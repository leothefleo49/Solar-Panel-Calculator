 ...
 * Ensures all files are properly configured for v1.4.9 release
 */
...
if (allPassed) {
  ...
  console.log('   2. Commit: git add -A && git commit -m "Release v1.4.9"');
  console.log('   3. Tag: git tag v1.4.9');
