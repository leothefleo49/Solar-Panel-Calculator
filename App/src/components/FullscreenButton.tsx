...
const FullscreenButton = () => {
  ...
  return (
    <button
      ...
      className="fixed top-4 right-4 z-50 rounded-xl border border-white/10 bg-slate-900/80 p-2.5 text-white backdrop-blur-sm transition hover:border-accent hover:bg-slate-800/90"
