...
const FullscreenButton = () => {
  ...
  return (
    <button
      ...
      className="fixed top-3 right-3 z-50 rounded-lg border border-white/10 bg-slate-900/80 p-2 text-white backdrop-blur-sm transition hover:border-accent hover:bg-slate-800/90"
